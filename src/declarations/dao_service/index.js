...
import { idlFactory } from './dao_service.did.js';
export { idlFactory } from './dao_service.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAO_SERVICE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dao_service.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dao_service canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dao_service.did.js")._SERVICE>}
 */
export const dao_service = createActor(canisterId);
