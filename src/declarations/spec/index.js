...
import { idlFactory } from './spec.did.js';
export { idlFactory } from './spec.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SPEC_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./spec.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the spec canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./spec.did.js")._SERVICE>}
 */
export const spec = createActor(canisterId);
