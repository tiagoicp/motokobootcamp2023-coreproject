...
import { idlFactory } from './proposal_service.did.js';
export { idlFactory } from './proposal_service.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PROPOSAL_SERVICE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proposal_service.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proposal_service canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proposal_service.did.js")._SERVICE>}
 */
export const proposal_service = createActor(canisterId);
